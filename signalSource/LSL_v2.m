classdef LSL_v2 < Signal_IO
    ...
    methods
        ...
        % respectively
        function lsl = LSL_v2(trialLength,includeDelay,channels,debugMode)
...
%                 lsl.Marker_inlet.open_stream();
        ...
        function data = readBufferOld(obj)
        ...
        function data=readBuffer_depricated(obj)
        %READBUFFER reads data from the signal buffer
            if(~obj.debugMode)
                obj.waitingOnData=true;
                while(obj.waitingOnData)
