function [keyIsDown,secs, keyCode, deltaSecs] = KbCheck(deviceNumber, unusedUntilTime, ptb_kbcheck_enabledKeys, varargin)
...
%             values.
% 05/05/16 nrw adjusted the 'white list' of keys so that they are locally
%             passed instead of using a global variable
